...
def solve_sudoku(puzzle):
    ...
    # we return if the solution exists or not
    # mutates puzzle to be the solution (if solution exists)
    
    # step 1: choose a loc  on the puzzle to make a guess
    ...
    # step 2: if there is a place and decide from 1-9
    ...
    # step 6: if none of the numbers that we try work, then this puzzle is not solvable
    return False
